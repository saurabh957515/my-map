    ...
    >
      <div className="grid space-y-5 max-xl:grid-cols-3 sm:grid">
        <div className="col-span-4 max-sm:mb-3">
          <InputLabel
            forInput="choose_canvaser"
            value="Choose Canvaser"
            className="mb-2"
          />
          <ReactSelect
            name="choose_canvaser"
            value={data?.choose_canvaser}
            placeholder="Choose Canvaser"
            options={canvaser}
            onChange={(val, action) => {
              setData('choose_canvaser', val);
            }}
          />
          <InputError message={errors?.choose_canvaser} className="mt-2" />
        </div>
        <div className="col-span-4 max-sm:mb-3">
